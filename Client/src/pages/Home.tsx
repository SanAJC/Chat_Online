  ...
  return (
    <>
      <div className=" flex h-screen overflow-hidden w-full">
        ...
        <div className="flex flex-col w-[45%] h-screen   bg-[#DDF2F3] rounded-t-3xl p-10 ml-3">
          <h1 className="font-medium text-black text-3xl border-b border-gray-400 mt-4 pb-2">{userReceiver || "Seleciona un chat para iniciar"}</h1>
